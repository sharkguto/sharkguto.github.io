...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1401: x0 => x0.assetsDir,
      _1402: () => globalThis.flet,
      _1403: Date.now,
      ...
      _1528: x0 => x0.random(),
      _1529: (x0,x1) => x0.getRandomValues(x1),
      _1530: () => globalThis.crypto,
      ...
      _1551: (x0,x1) => x0.exec(x1),
      _1552: (x0,x1) => x0.test(x1),
      _1553: x0 => x0.pop(),
      _1555: o => o === undefined,
      _1557: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1559: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1560: o => o instanceof RegExp,
      _1561: (l, r) => l === r,
      _1562: o => o,
      _1563: o => o,
      _1564: o => o,
      ...
      _1622: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1622(f,arguments.length,x0) }),
      _1627: (x0,x1) => new WebSocket(x0,x1),
      _1628: (x0,x1) => x0.send(x1),
      _1629: (x0,x1,x2) => x0.close(x1,x2),
      _1631: x0 => x0.close(),
      _1634: () => new AbortController(),
      _1635: x0 => x0.abort(),
      _1636: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1637: (x0,x1) => globalThis.fetch(x0,x1),
      _1638: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1638(f,arguments.length,x0,x1,x2) }),
      _1639: (x0,x1) => x0.forEach(x1),
      _1640: x0 => x0.getReader(),
      _1641: x0 => x0.cancel(),
      _1642: x0 => x0.read(),
      _1643: (x0,x1,x2,x3) => ({method: x0,headers: x1,body: x2,credentials: x3}),
      _1644: (x0,x1,x2) => x0.fetch(x1,x2),
      _1645: (x0,x1) => x0.key(x1),
      _1646: o => o instanceof Array,
      _1647: (a, i) => a.push(i),
      _1648: (a, i) => a.splice(i, 1)[0],
      _1649: (a, i, v) => a.splice(i, 0, v),
      _1651: a => a.pop(),
      _1652: (a, i) => a.splice(i, 1),
      _1654: (a, s, e) => a.slice(s, e),
      _1656: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1657: a => a.length,
      _1658: (a, l) => a.length = l,
      _1659: (a, i) => a[i],
      _1660: (a, i, v) => a[i] = v,
      _1662: o => {
      ...
      _1663: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1665: o => o instanceof Uint8Array,
      _1666: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1667: o => o instanceof Int8Array,
      _1668: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1669: o => o instanceof Uint8ClampedArray,
      _1670: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1671: o => o instanceof Uint16Array,
      _1672: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1673: o => o instanceof Int16Array,
      _1674: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1675: o => o instanceof Uint32Array,
      _1676: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1677: o => o instanceof Int32Array,
      _1678: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1680: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1681: o => o instanceof Float32Array,
      _1682: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1683: o => o instanceof Float64Array,
      _1684: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1685: (t, s) => t.set(s),
      _1686: l => new DataView(new ArrayBuffer(l)),
      _1687: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1688: o => o.byteLength,
      _1689: o => o.buffer,
      _1690: o => o.byteOffset,
      _1691: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1692: (b, o) => new DataView(b, o),
      _1693: (b, o, l) => new DataView(b, o, l),
      _1694: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1695: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1696: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1697: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1698: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1699: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1700: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1701: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1702: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1703: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1704: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1705: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1706: Function.prototype.call.bind(DataView.prototype.getBigUint64),
      _1708: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1709: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1710: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1711: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1712: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1713: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1714: Function.prototype.call.bind(Number.prototype.toString),
      _1715: Function.prototype.call.bind(BigInt.prototype.toString),
      _1716: Function.prototype.call.bind(Number.prototype.toString),
      _1717: (d, digits) => d.toFixed(digits),
      _1730: () => globalThis.document,
      _1731: () => globalThis.window,
      _1736: (x0,x1) => { x0.height = x1 },
      _1738: (x0,x1) => { x0.width = x1 },
      _1740: (x0,x1) => { x0.pointerEvents = x1 },
      _1743: x0 => x0.head,
      _1744: x0 => x0.classList,
      _1748: (x0,x1) => { x0.innerText = x1 },
      _1749: x0 => x0.style,
      _1751: x0 => x0.sheet,
      _1752: x0 => x0.src,
      _1753: (x0,x1) => { x0.src = x1 },
      _1754: x0 => x0.naturalWidth,
      _1755: x0 => x0.naturalHeight,
      _1762: x0 => x0.offsetX,
      _1763: x0 => x0.offsetY,
      _1764: x0 => x0.button,
      _1771: x0 => x0.status,
      _1772: (x0,x1) => { x0.responseType = x1 },
      _1774: x0 => x0.response,
      _1823: (x0,x1) => { x0.responseType = x1 },
      _1824: x0 => x0.response,
      _1884: (x0,x1) => { x0.draggable = x1 },
      _1900: x0 => x0.style,
      _2257: (x0,x1) => { x0.target = x1 },
      _2259: (x0,x1) => { x0.download = x1 },
      _2284: (x0,x1) => { x0.href = x1 },
      _2377: (x0,x1) => { x0.src = x1 },
      _2829: (x0,x1) => { x0.accept = x1 },
      _2843: x0 => x0.files,
      _2869: (x0,x1) => { x0.multiple = x1 },
      _2887: (x0,x1) => { x0.type = x1 },
      _3136: (x0,x1) => { x0.src = x1 },
      _3138: (x0,x1) => { x0.type = x1 },
      _3142: (x0,x1) => { x0.async = x1 },
      _3156: (x0,x1) => { x0.charset = x1 },
      _3605: () => globalThis.window,
      _3664: x0 => x0.navigator,
      _3668: x0 => x0.screen,
      _3671: x0 => x0.innerHeight,
      _3675: x0 => x0.screenLeft,
      _3679: x0 => x0.outerHeight,
      _3927: x0 => x0.sessionStorage,
      _3928: x0 => x0.localStorage,
      _4029: x0 => x0.clipboard,
      _4037: x0 => x0.maxTouchPoints,
      _4044: x0 => x0.appCodeName,
      _4045: x0 => x0.appName,
      _4046: x0 => x0.appVersion,
      _4047: x0 => x0.platform,
      _4048: x0 => x0.product,
      _4049: x0 => x0.productSub,
      _4050: x0 => x0.userAgent,
      _4051: x0 => x0.vendor,
      _4052: x0 => x0.vendorSub,
      _4054: x0 => x0.language,
      _4055: x0 => x0.languages,
      _4056: x0 => x0.onLine,
      _4061: x0 => x0.hardwareConcurrency,
      _4101: x0 => x0.data,
      _4258: x0 => x0.length,
      _4475: x0 => x0.readyState,
      _4484: x0 => x0.protocol,
      _4488: (x0,x1) => { x0.binaryType = x1 },
      _4491: x0 => x0.code,
      _4492: x0 => x0.reason,
      _6159: x0 => x0.type,
      _6200: x0 => x0.signal,
      _6261: x0 => x0.firstChild,
      ...
      _9022: x0 => x0.width,
      _9023: x0 => x0.height,
      _10855: (x0,x1) => { x0.border = x1 },
      _11133: (x0,x1) => { x0.display = x1 },
      _11297: (x0,x1) => { x0.height = x1 },
      _11987: (x0,x1) => { x0.width = x1 },
      _12278: x0 => x0.charging,
      _12281: x0 => x0.level,
      _12283: (x0,x1) => { x0.onchargingchange = x1 },
      _12355: x0 => x0.name,
      _12356: x0 => x0.message,
      _13098: x0 => x0.x,
      _13099: x0 => x0.y,
      _13100: x0 => x0.z,
      _13101: (x0,x1) => { x0.onreading = x1 },
      _13102: (x0,x1) => { x0.onerror = x1 },
      _13103: x0 => x0.x,
      _13104: x0 => x0.y,
      _13105: x0 => x0.z,
      ...
      _13109: x0 => x0.y,
      _13110: x0 => x0.z,
      _13111: (x0,x1) => { x0.onreading = x1 },
      _13112: (x0,x1) => { x0.onerror = x1 },
      _13113: x0 => x0.x,
      _13114: x0 => x0.y,
      _13115: x0 => x0.z,
      ...
      _13118: x0 => x0.error,
      _13119: x0 => x0.name,
      _13120: x0 => x0.message,
      _13125: x0 => globalThis.Wakelock.toggle(x0),
      _13126: () => globalThis.Wakelock.enabled(),
